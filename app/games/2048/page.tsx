        ...
        {showModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
            <div className="bg-white rounded-xl shadow-2xl p-8 max-w-xs w-full text-center animate-in fade-in">
              <h2 className="text-3xl font-bold mb-4 text-amber-700">{t.startNewGame}</h2>
                <div className="mt-8 text-center max-w-md animate-in fade-in slide-in-from-bottom duration-700 delay-500">
                  <p className="text-amber-700/70 text-sm md:text-base leading-relaxed pb-8">
                    <strong className="text-amber-800">{t.howtoplay}</strong>
                  </p>
                </div>
              <button
